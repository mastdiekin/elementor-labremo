...
class Inline_Editing extends Widget_Base {
	...
	public function get_title() {
		return __( 'Inline Editing', 'elementor-labremo' );
	}
	...
	protected function _register_controls() {
		...
		$this->add_control(
			...
			[
				...
				'default' => __( 'Title', 'elementor-labremo' ),
			]
		);
		...
		$this->add_control(
			'description',
			[
				'label' => __( 'Description', 'elementor-labremo' ),
				'type' => Controls_Manager::TEXTAREA,
				'default' => __( 'Description', 'elementor-labremo' ),
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'default' => __( 'Content', 'elementor-labremo' ),
			]
		);
