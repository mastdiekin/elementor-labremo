 ...
 * @since 1.0.0
 */
class Scrollax_Image extends Widget_Base {
	...
	public function get_title() {
		return __( 'Labremo Scrollax Image', 'elementor-labremo' );
	}
	...
	protected function render() {
		...
		$this->add_render_attribute( 'wrapper', 'data-scrollax-parent', 'true' );
